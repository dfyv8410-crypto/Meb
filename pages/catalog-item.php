...
if ($single) {
    ...
    echo meb_pic(first_image($single), (string) ($single['title'] ?? ''), ['class' => 'detail-hero', 'w' => 1600, 'h' => 900, 'fit' => 'cover', 'q' => 82, 'sizes' => '100vw', 'eager' => true]);
...
foreach ($items as $c) {
    ...
    echo '<div class="card-img-wrap">' . meb_pic(first_image($c), (string) ($c['title'] ?? ''), ['w' => 640, 'h' => 480, 'fit' => 'cover', 'q' => 80, 'sizes' => '(min-width:1081px) 300px, (min-width:721px) 33vw, calc(100vw - 40px)']) . '</div>';
