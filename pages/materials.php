  ...
  <div class="grid cols3">
    <?php
      ...
      foreach ($materials as $m) {
        ...
        echo '<div class="card-img-wrap">' . meb_pic(first_image($m), (string) ($m['title'] ?? ''), ['w' => 640, 'h' => 480, 'fit' => 'cover', 'q' => 80, 'sizes' => '(min-width:1081px) 300px, (min-width:721px) 33vw, 100vw']) . '</div>';
